...
data_directory = root_path + "/data/filtered_data/press_conference_labeled/"#"../data/filtered_data/speech_labeled/" #"../data/filtered_data/meeting_minutes_labeled/"
...
## for PC
master_file_path = root_path + "data/master_files/master_pc_final.xlsx"
...
df_master.to_excel(root_path + "data/market_analysis_data/aggregate_measure_pc.xlsx", index=False)
