...
sys.path.append((os.path.dirname(os.path.abspath(os.path.dirname('FinQA/code/utilss/general_utils')))))
from utilss.general_utils import table_row_to_text
...
if __name__ == '__main__':
    ...
    json_in = "/home/jaeyoung/FinQA/output/bert_uncased_inference_output/retriever/bert-base-uncased_train/results/test/predictions.json"
    json_out = "./dataset/bert_correct/train_retrieve_correct.json"
    convert_test(json_in, json_out, topn=3, max_len=290)

    # json_in = "/home/seyunn/finbert/downstream/FinQA/FinQA/retriever-inference_89/inference_only_20221121161019_roberta-base-infer-dev/results/test/predictions.json"
    # json_out = "/home/seyunn/finbert/downstream/FinQA/FinQA/retriever-inference_89/retrieve_dev_t5_correct.json"
